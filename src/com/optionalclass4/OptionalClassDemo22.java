...
public class OptionalClassDemo22 {
...
//		System.out.println(phone);
		...
		String name = myst1.flatMap(s->s.getCourse().flatMap(c->c.getTrainer().map(t->t.getName()))).orElse("no name provided");
		String email = myst1.flatMap(s->s.getCourse().flatMap(c->c.getTrainer().map(t->t.getEmail()))).orElse("no email provided");
		String phone = myst1.flatMap(s->s.getCourse().flatMap(c->c.getTrainer().map(t->t.getPhone()))).orElse("no phone provided");
